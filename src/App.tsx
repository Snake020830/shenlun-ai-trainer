...
const navItems = [
  ...
  { id: "materials" as const, label: "素材积累", icon: BookMarked },
...
export default function App() {
  ...
  else if (view === "library") content = <QuestionLibraryPage allQuestions={allQuestions} onStart={start} onImport={() => setView("import")} onRefreshImported={refreshImportedQuestions} onDeepRead={openMaterials}/>;
  ...
  return <div className="app-shell"><Sidebar view={view} onChange={next => { if (next === "materials") setMaterialQuestionId(null); setView(next); }}/>{content}</div>;
}

...
## 2026-09-01 — 独立时事素材精读与批改结果展示

- 素材精读页移除真题精读入口，不再把整套真题的多段材料带入精读流程；真题继续只服务于作答训练。
- 每日素材改为新闻流：每天 9 篇，以中央/全国权威栏目为主，混合跨地区治理案例与少量安徽素材，点击任意一篇即可精读，不再强制选满 2 篇。
- 候选排序综合时效、主题匹配、正文可读性和来源范围，过滤未来日期及低信息量标题；旧版每日文章缓存自动失效。
- 根据公开可核验的近十年安徽省考资料汇总：历年公开卷多为考生回忆版，通常不保留原始媒体署名，不能据此伪造精确的媒体占比；产品按“中央/全国 6 篇、全国地方实践 2 篇、安徽实践 1 篇”的可解释配比落地，后续可继续用带明确来源标记的样本校正。
- 文章来源扩展为中国政府网、新华网时政/地方/长三角及安徽省政府网，避免把安徽本地来源误当作安徽联考的唯一代表。
- 修正答题卡底部批改结果区域的布局高度，提交后可正常看到结构化批改反馈。
